...
import { BankTransferReceiptInfo } from "./BankTransferReceiptInfo";
...
const OrderTransactionPayment = ({
  ...
  return (
    <OrderTransaction
      ...
      cardFooter={payment.bankTransferReceipt ? <BankTransferReceiptInfo receipt={payment.bankTransferReceipt} /> : null}
    />
  );
};
